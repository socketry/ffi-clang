	...
	module Clang
		module Lib
			...
			enum :calling_conv, [
				...
				:calling_conv_riscv_vls_call_32, 22,
				:calling_conv_riscv_vls_call_64, 23,
				:calling_conv_riscv_vls_call_128, 24,
				:calling_conv_riscv_vls_call_256, 25,
				:calling_conv_riscv_vls_call_512, 26,
				:calling_conv_riscv_vls_call_1024, 27,
				:calling_conv_riscv_vls_call_2048, 28,
				:calling_conv_riscv_vls_call_4096, 29,
				:calling_conv_riscv_vls_call_8192, 30,
				:calling_conv_riscv_vls_call_16384, 31,
				:calling_conv_riscv_vls_call_32768, 32,
				:calling_conv_riscv_vls_call_65536, 33,
